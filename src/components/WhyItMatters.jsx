const WhyItMatters = () => {
  return (
    <section id="why-it-matters" className="py-28 lg:py-32 bg-[#0a0d12] relative overflow-hidden">
      {/* Subtle glow */}
      <div className="absolute top-0 left-1/2 -translate-x-1/2 w-[600px] h-[400px] bg-[#4a9ead]/5 rounded-full blur-[150px] pointer-events-none" />
      
      {/* Decorative lines */}
      <div className="absolute left-8 top-1/4 bottom-1/4 w-px bg-gradient-to-b from-transparent via-[#4a9ead]/20 to-transparent hidden lg:block" />
      <div className="absolute right-8 top-1/4 bottom-1/4 w-px bg-gradient-to-b from-transparent via-[#4a9ead]/20 to-transparent hidden lg:block" />
      ...
      <div className="max-w-[1200px] mx-auto px-6 relative z-10">
        <div className="max-w-[800px] mx-auto text-center">
          ...
          <div className="space-y-8">
            <div className="animate-on-scroll bg-[#0d1118]/60 backdrop-blur-sm border border-[#4a9ead]/10 rounded-xl p-8">
              <p className="text-[#7a9aaa] text-lg leading-relaxed">
