  ...
  return (
    <section className="relative overflow-hidden bg-[#0a0d12]">
      ...
      <div className="min-h-screen flex items-center justify-center relative">
        ...
        {/* Scanning Line */}
        <div 
          className="absolute left-0 right-0 h-[2px] bg-gradient-to-r from-transparent via-[#FF91AF]/50 to-transparent pointer-events-none transition-all duration-75"
          style={{ top: `${scanLine}%`, boxShadow: '0 0 20px 2px rgba(255, 145, 175, 0.3)' }}
        />
        ...
        <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
          {/* Small label */}
          <div className="inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#FF91AF]/20 bg-[#FF91AF]/5 mb-8">
            <span className="w-2 h-2 rounded-full bg-[#FF91AF] animate-pulse" />
            <span className="text-[#FF91AF] text-xs font-mono uppercase tracking-wider">Behavioral Analysis System</span>
          </div>
