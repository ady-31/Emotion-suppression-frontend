  ...
  return (
    <section className="min-h-screen flex items-center justify-center relative overflow-hidden bg-[#0a0d12]">
      ...
      <div className="absolute inset-0">
        ...
        <div className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[500px] h-[650px]">
          <div className="absolute inset-0 bg-gradient-radial from-[#1a2030]/60 via-[#151b28]/40 to-transparent rounded-[50%_50%_45%_45%]" />
        </div>
      ...
      <div className="relative z-10 text-center px-6 max-w-3xl mx-auto">
        {/* Small label */}
        <div className="hero-fade-in inline-flex items-center gap-2 px-4 py-2 rounded-full border border-[#4a9ead]/20 bg-[#4a9ead]/5 mb-8">
          <span className="w-2 h-2 rounded-full bg-[#4a9ead] animate-pulse" />
          <span className="text-[#4a9ead] text-xs font-mono uppercase tracking-wider">Behavioral Analysis System</span>
        </div>

        {/* Main Title */}
        <h1 className="hero-fade-in-delay-1 text-4xl md:text-5xl lg:text-6xl font-light text-white mb-6 leading-tight">
          Emotion Suppression
          <span className="block text-[#4a9ead] font-normal">Detection</span>
        </h1>

        {/* Subtitle */}
        <p className="hero-fade-in-delay-2 text-lg md:text-xl text-[#7a9aaa] font-light mb-4 leading-relaxed max-w-2xl mx-auto">
          Advanced analysis of subtle facial behavior and expressive timing
        </p>

        {/* Tagline */}
        <p className="hero-fade-in-delay-2 text-sm text-[#4a9ead]/60 font-mono tracking-wider mb-10 italic">
